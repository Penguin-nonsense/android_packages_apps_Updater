...
updates_dir=/data/penguinos_updates
...
adb shell "killall com.penguinos.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.penguinos.updater/databases/updates.db" \
