...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.penguinos.version";
    public static final String PROP_DEVICE = "ro.penguinos.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "penguinos.updater.allow_downgrading";
